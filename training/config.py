...
DEFAULT_CONFIG = {
    ...
    "env": {
        ...
        "domain_randomization": {
            "enabled": True,
            "tire_friction_range": [0.66, 0.85],
            "vehicle_mass_range": [3.29, 3.60],
            ...
            "imu_accel_bias_range": [-0.15, 0.15],
            "imu_gyro_bias_range": [-0.006607313505033768, 0.006607313505033768],
            "imu_accel_noise_std_range": [0.07268478585321053, 0.14536957170642106],
            "imu_gyro_noise_std_range": [0.01317795169125509, 0.02635590338251018],
            "imu_axis_misalign_range": [0.0, 0.02],
            "vesc_speed_bias_range": [-0.03165226619154528, 0.03165226619154528],
            "vesc_current_bias_range": [-0.05, 0.05],
            "vesc_speed_noise_std_range": [0.0, 0.022474802475579557],
            "vesc_current_noise_std_range": [0.0, 0.05],
        },
    },
    "sensor": {
        "num_beams": 1081,
    ...
    # Seeded fixed opponent pool. Entries are loaded once; each env samples
    # a weighted opponent on every episode reset.
    "fixed_opponents": {
        "entries": [],
    },
    "selfplay": {
